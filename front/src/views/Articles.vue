...
onMounted(async () => {
  try {
    ...
    posts.value = data || []
    if (!selectedPost.value && posts.value.length) {
...
.post-content { font-size: 1rem; line-height: 1.9; overflow-wrap: anywhere; }
...
@media (max-width: 640px) {
  ...
  .sidebar-item.active {
    ...
    box-shadow: 0 0 0 2px rgba(91, 140, 90, 0.12);
  }
